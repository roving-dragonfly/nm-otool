...
/*   Updated: 2019/02/13 02:34:21 by aalves           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_proc_infos	*parse_cl(int argc, char **argv)
{
	...
	while ((flag = ft_getopt(argc, argv, T_OTOOL_FLAGS)) != -1)
	{
		...
		cmd.flags ^= 1U << (uint64_t)(ft_strchr(T_OTOOL_FLAGS, flag) - T_OTOOL_FLAGS);
	}
